...
public class PollServiceGrpc {
  ...
  private static final io.grpc.stub.Method<io.grpc.examples.trial1.PollRequest,
      io.grpc.examples.trial1.PollResponse> METHOD_CREATE_POLL =
      io.grpc.stub.Method.create(
          io.grpc.MethodType.UNARY, "CreatePoll",
          io.grpc.proto.ProtoUtils.marshaller(io.grpc.examples.trial1.PollRequest.PARSER),
          io.grpc.proto.ProtoUtils.marshaller(io.grpc.examples.trial1.PollResponse.PARSER));
  ...
  public static class PollServiceServiceDescriptor extends
    ...
    public final io.grpc.MethodDescriptor<io.grpc.examples.trial1.PollRequest,
        io.grpc.examples.trial1.PollResponse> createPoll;

    private PollServiceServiceDescriptor() {
      createPoll = createMethodDescriptor(
          "io.grpc.examples.trial1.PollService", METHOD_CREATE_POLL);
    }

    @SuppressWarnings("unchecked")
    private PollServiceServiceDescriptor(
        java.util.Map<java.lang.String, io.grpc.MethodDescriptor<?, ?>> methodMap) {
      createPoll = (io.grpc.MethodDescriptor<io.grpc.examples.trial1.PollRequest,
          io.grpc.examples.trial1.PollResponse>) methodMap.get(
  ...
  public static interface PollService {
    ...
    public void createPoll(io.grpc.examples.trial1.PollRequest request,
        io.grpc.stub.StreamObserver<io.grpc.examples.trial1.PollResponse> responseObserver);
  }

  public static interface PollServiceBlockingClient {

    public io.grpc.examples.trial1.PollResponse createPoll(io.grpc.examples.trial1.PollRequest request);
  }

  public static interface PollServiceFutureClient {

    public com.google.common.util.concurrent.ListenableFuture<io.grpc.examples.trial1.PollResponse> createPoll(
        io.grpc.examples.trial1.PollRequest request);
  }
  ...
  public static io.grpc.ServerServiceDefinition bindService(
    ...
    return io.grpc.ServerServiceDefinition.builder("io.grpc.examples.trial1.PollService")
      .addMethod(createMethodDefinition(
          METHOD_CREATE_POLL,
          asyncUnaryRequestCall(
            new io.grpc.stub.ServerCalls.UnaryRequestMethod<
                io.grpc.examples.trial1.PollRequest,
                io.grpc.examples.trial1.PollResponse>() {
              @java.lang.Override
              public void invoke(
                  io.grpc.examples.trial1.PollRequest request,
                  io.grpc.stub.StreamObserver<io.grpc.examples.trial1.PollResponse> responseObserver) {
